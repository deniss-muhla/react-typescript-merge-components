...
export default function App() {
  return (
    <div className="App">
      ...
      <BaseButton value="Base Button" />
      <IconButton value="Icon Button" iconPath={rocketIcon} />
      <CheckButton value="Check Button" defaultChecked />
      <br />
      Use single component:
      <Button value="Button" />
      <Button value="Button" iconPath={rocketIcon} />
      <Button value="Button" defaultChecked />
    </div>
  );
}
